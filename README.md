...
Исправим сведения о сетях в `variables.tf` и в `vms_platforn.tf` (`nat=false`), при этом для целей задания  временн на одной ВМ оставим доступ в интернет (`nat=true`), чтобы  настроить логин и пароль. 

<img src = "img/9-1.png" width = 60%>  
 
Запустим инфраструктуру. В Web-консоли Yandex-cloud увидим публичный ip для открытой ВМ.  
Зайдем на ней со своего хоста.  
`ssh -i /home/yury/HW/terraform/02/secrets/yandex-cloud-key ubuntu@158.16
0.107.188`  

<img src = "img/9-2.png" width = 60%>  

и настроим пароль и логин.  

<img src = "img/9-3.png" width = 60%>

После этого изменим конфигурацию, исправив `variables.tf`  (`nat=false`) и применим (apply).

<img src = "img/9-4.png" width = 60%>

Зайдем на одну ВМ  через serial console (логин  и пароль ранее настроены) и проверим доступ с неё в интернет.

<img src = "img/9-5.png" width = 60%>
